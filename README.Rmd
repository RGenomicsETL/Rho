...
`rho.ext` runtime is not connected to `rho.agent`; `rho.bio.agent` only lists
registered manifests; the DuckDB SQL guard is lexical; and coding file/Bash
tools still inherit host filesystem and environment authority. These gaps are
tracked in issues [#7](https://github.com/RGenomicsETL/Rho/issues/7),
